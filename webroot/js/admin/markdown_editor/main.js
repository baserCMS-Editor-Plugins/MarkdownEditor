...
var InputArea = React.createClass({displayName: "InputArea",
	render: function () {
		return (
			React.createElement("div", {class: "markdown-editor__input-area"}, 
...
},{"./InputArea.jsx":149,"./PreviewArea.jsx":151,"react":148}],151:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
...
var PreviewArea = React.createClass({displayName: "PreviewArea",
	render: function () {
		return (
			React.createElement("div", {className: "preview-area__output", dangerouslySetInnerHTML: {__html: marked(this.props.text)}})
		);
	}
});
...
},{"marked":2,"react":148}],152:[function(require,module,exports){
...
$(function() {
	...
	if (!window.bcPluginMarkdownEditor.embedded) {
		...
		React.render(React.createElement(Main, null), $markdownEditor[0]);

	}

});
},{"./MarkdownEditor.jsx":150,"react":148}]},{},[152]);
